...
// Fallback mock data when the backend is not available
const MOCK_TASKS: Task[] = [
  {
    id: "task_001",
    input: "Research the latest advancements in quantum computing and summarize key breakthroughs.",
    output: "Found 12 papers published in Q1 2025. Key breakthroughs include error correction at room temperature and 1000-qubit processors from IBM and Google.",
    created_at: new Date(Date.now() - 3_600_000).toISOString(),
  },
  {
    id: "task_002",
    input: "Write a Python script to scrape product prices from an e-commerce site.",
    output: "Generated scraper using requests + BeautifulSoup. Script exports to CSV. Rate-limiting and retry logic included.",
    created_at: new Date(Date.now() - 7_200_000).toISOString(),
  },
  {
    id: "task_003",
    input: "Analyze the sentiment of customer reviews from the provided dataset.",
    output: "Completed sentiment analysis on 5,432 reviews. Positive: 68%, Neutral: 21%, Negative: 11%. Top complaint: delivery time.",
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div
            ...
            style={{ background: "var(--surface-raised)", color: "var(--muted)", border: "1px solid var(--surface-border)" }}
          >
